...
--PROFESSORS,STUDENTS,COURSES에서 참조하고 있다.

DROP TABLE PROFESSORS;

--STUDENTS,COURSES 에서 참조하고 있다.
...
-- CASCADE CONSTRAINTS는 이 테이블을 참조하는 자식 테이블에서 외래키 제약조건을
-- 제거한 다음, 이 테이블을 삭제한다.
...
*제약조건 삭제하기
ALTER TABLE 테이블명 DROP CONSTRAINT 제약조건 별칭;

*제약조건 비활성화하기
ALTER TABLE 테이블명 DISABLE CONSTRAINT 제약조건 별칭;

*제약조건 활성화하기
ALTER TABLE 테이블명 ENABLE CONSTRAINT 제약조건 별칭;
