...
-- 보고할 상사없는 직원의 아이디, 이름, 직종아이디를 조회하기
...
-- 직원 중에서 100번 상사에게 보고하고, 커미션을 받으며, 급여를 10000달러 이상 받는 
...
-- 직원 중에서 소속부서가 50, 60, 80번 부서 중의 하나에 속하고, 
-- 100번 직원에게 보고하는 직원의 아이디, 이름, 직종아이디, 부서아이디를 조회하기
SELECT EMPLOYEE_ID, FIRST_NAME, JOB_ID, DEPARTMENT_ID
FROM EMPLOYEES
WHERE DEPARTMENT_ID IN (50, 60, 80)
AND MANAGER_ID = 100;

-- 직원 중에서 직종아이디가  'CLERK'로 끝나고, 급여를 2000불 이상 받는 
-- 직원의 아이디, 이름, 급여, 직종아이디를 조회하기
